...
public class BiomedicalEng extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tbl_bioEng = new javax.swing.JTable();
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Department of Biomedical Engineering", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("sansserif", 1, 14), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        tbl_bioEng.setBorder(null);
        tbl_bioEng.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tbl_bioEng.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbl_bioEngMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tbl_bioEng);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 55, 584, 173));
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(txt_name, javax.swing.GroupLayout.DEFAULT_SIZE, 167, Short.MAX_VALUE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 234, 584, -1));
        ...
        jPanel1.add(btn_add, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 476, 270, -1));
        ...
        jPanel1.add(btn_delete, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 148, 138, 49));
        ...
        jPanel1.add(btn_showAllStuffs, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 73, 138, 46));
        ...
        jPanel1.add(btn_update, new org.netbeans.lib.awtextra.AbsoluteConstraints(326, 476, 278, -1));
        jPanel1.add(lbl_image, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 60, 630, 470));
    ...
    private void btn_showAllStuffsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_showAllStuffsActionPerformed
        ...
        DemirbasDB.ShowAllforBiomediclEng(tbl_table_model);
    }//GEN-LAST:event_btn_showAllStuffsActionPerformed

    private void btn_deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_deleteActionPerformed
        if (tbl_bioEng.getSelectedRow() >= 0) {
            int id = (int) tbl_bioEng.getValueAt(tbl_bioEng.getSelectedRow(), 0);
            DemirbasDB.DeleteByID(id);
            tbl_table_model.removeRow(tbl_bioEng.getSelectedRow());
            btn_delete.setEnabled(false);
        } else {
            return;
        }
    ...
    private void tbl_bioEngMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_bioEngMouseClicked
        if (tbl_bioEng.getSelectedRow() >= 0) {
            int id = (int) tbl_bioEng.getValueAt(tbl_bioEng.getSelectedRow(), 0);
    ...
    }//GEN-LAST:event_tbl_bioEngMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BiomedicalEng.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BiomedicalEng().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tbl_bioEng;
